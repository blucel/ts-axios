...
describe('headers:url', () => {
  ...
  describe('isAbsoluteURL', () => {
    ...
    test('should return true if URL is protocal-relative', () => {
      expect(buildURL('//example.com/')).toBeTruthy()
    })
  ...
  describe('combineURL', () => {
    test('should combine URL', () => {
      expect(combineURL('http://api.github.com', '/users')).toBe('http://api.github.com/users')
    })
  ...
  describe('isURLSameOrigin', () => {
    ...
    test('should detect different origin', () => {
      expect(isURLSameOrigin('https://sads/sda')).toBeFalsy()
    })
  })
})
