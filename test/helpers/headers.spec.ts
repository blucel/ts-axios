...
describe('helpers:header', () => {
  ...
  describe('processHeaders', () => {
    ...
    test('should set ContentType if not set and data is PlainObject', () => {
      const headers: any = {}
      processHeaders(headers, { a: 1 })
      expect(headers['Content-Type']).toBe('application/json;charset=utf-8')
    })

    test('should set ContentType if not set and data is not PlainObject', () => {
      const headers: any = {}
  ...
  describe('flattenHeaders', () => {
    test('should flatten the headers and include common headers', () => {
      const headers = {
        ...
        common: {
          X_COMMON_HEADER: 'commonHeaderValue'
        },
        get: {
          X_GET_HEADER: 'getHeaderValue'
        },
        post: {
          X_POST_HEADER: 'postHeaderValue'
        }
      }
